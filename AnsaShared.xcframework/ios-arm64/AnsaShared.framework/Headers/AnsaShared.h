...
@property (readonly) NSString *to __attribute__((swift_name("to")));
@property (readonly) NSString *type __attribute__((swift_name("type")));
- (instancetype)initWithId:(NSString *)id type:(NSString *)type amount:(int32_t)amount createdAtIso:(NSString *)createdAtIso source:(NSString * _Nullable)source paymentMethodId:(NSString * _Nullable)paymentMethodId reason:(NSString * _Nullable)reason from:(NSString *)from to:(NSString *)to metadataJson:(NSString * _Nullable)metadataJson label:(NSString * _Nullable)label displayName:(NSString * _Nullable)displayName __attribute__((swift_name("init(id:type:amount:createdAtIso:source:paymentMethodId:reason:from:to:metadataJson:label:displayName:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedCustomer_implTransactionResponse *)doCopyId:(NSString *)id type:(NSString *)type amount:(int32_t)amount createdAtIso:(NSString *)createdAtIso source:(NSString * _Nullable)source paymentMethodId:(NSString * _Nullable)paymentMethodId reason:(NSString * _Nullable)reason from:(NSString *)from to:(NSString *)to metadataJson:(NSString * _Nullable)metadataJson label:(NSString * _Nullable)label displayName:(NSString * _Nullable)displayName __attribute__((swift_name("doCopy(id:type:amount:createdAtIso:source:paymentMethodId:reason:from:to:metadataJson:label:displayName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
