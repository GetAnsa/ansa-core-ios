...
@class AnsaSharedBase, AnsaSharedMutableSet<E>, AnsaSharedMutableDictionary<K, V>, AnsaSharedNumber, AnsaSharedByte, AnsaSharedUByte, AnsaSharedShort, AnsaSharedUShort, AnsaSharedInt, AnsaSharedUInt, AnsaSharedLong, AnsaSharedULong, AnsaSharedFloat, AnsaSharedDouble, AnsaSharedBoolean, AnsaSharedKotlinEnum<E>, AnsaSharedKotlinEnumCompanion, AnsaSharedKotlinIllegalStateException, AnsaSharedKotlinRuntimeException, AnsaSharedKotlinException, AnsaSharedKotlinThrowable, AnsaSharedKotlinCancellationException, AnsaSharedKotlinUnit, AnsaSharedKotlinArray<T>, AnsaSharedKotlinNothing, AnsaSharedKotlinByteArray, AnsaSharedKotlinAbstractCoroutineContextElement, AnsaSharedKotlinByteIterator, AnsaSharedKotlinLongRange, AnsaSharedKotlinLongRangeCompanion, AnsaSharedKotlinLongProgression, AnsaSharedKotlinLongProgressionCompanion, AnsaSharedKotlinAbstractCoroutineContextKey<B, E>, AnsaSharedKotlinKTypeProjection, AnsaSharedKotlinKTypeProjectionCompanion, AnsaSharedKotlinLongIterator, AnsaSharedKotlinKVariance, AnsaSharedSkieColdFlowIterator<E>, AnsaSharedSkieKotlinFlow<T>, AnsaSharedSkieKotlinMutableSharedFlow<T>, AnsaSharedSkieKotlinMutableStateFlow<T>, AnsaSharedSkieKotlinOptionalFlow<T>, AnsaSharedSkieKotlinOptionalMutableSharedFlow<T>, AnsaSharedSkieKotlinOptionalMutableStateFlow<T>, AnsaSharedSkieKotlinOptionalSharedFlow<T>, AnsaSharedSkieKotlinOptionalStateFlow<T>, AnsaSharedSkieKotlinSharedFlow<T>, AnsaSharedSkieKotlinStateFlow<T>, AnsaSharedSkie_CancellationHandler, AnsaSharedSkie_SuspendHandler, AnsaSharedSkie_SuspendResult, AnsaSharedSkie_SuspendResultCanceled, AnsaSharedSkie_SuspendResultError, AnsaSharedSkie_SuspendResultSuccess, AnsaSharedKotlinx_coroutines_coreCoroutineDispatcher, AnsaSharedKotlinx_coroutines_coreCoroutineDispatcherKey, AnsaSharedCustomer, AnsaSharedUserPresetReloadAmounts, AnsaSharedUserReloadConfiguration, AnsaSharedAutoReloadConfiguration, AnsaSharedAutoReloadConfigurationRequest, AnsaSharedAutoReloadConfigurationStatusDisabled, AnsaSharedAutoReloadConfigurationStatusEnabled, AnsaSharedBalance, AnsaSharedBalanceUpdate, AnsaSharedAddBalanceRequest, AnsaSharedUseBalanceRequest, AnsaSharedBillingDetails, AnsaSharedAddPaymentMethodRequest, AnsaSharedAddPaymentMethodTypeKmpApplePay, AnsaSharedAddPaymentMethodTypeKmpCreditCard, AnsaSharedAddPaymentMethodTypeKmpGooglePay, AnsaSharedAddPaymentMethodTypeKmpSquare, AnsaSharedAddPaymentMethodTypeKmpStripe, AnsaSharedCard, AnsaSharedPaymentMethod, AnsaSharedPaymentMethodCollection, AnsaSharedInjectKmpAppComponent, AnsaSharedKmpAppComponent, AnsaSharedKmpAppComponentCompanion, AnsaSharedInjectKmpAppComponentKt, AnsaSharedImplRealAuthSessionManager, AnsaSharedImplRealCustomerRepository, AnsaSharedImplCustomerMapper, AnsaSharedImplPaymentMethodListMapper, AnsaSharedImplAddPaymentMethodMapper, AnsaSharedImplAutoReloadConfigMapper, AnsaSharedImplAddBalanceMapper, AnsaSharedImplUseBalanceMapper, AnsaSharedImplUserReloadConfigurationMapper, AnsaSharedImplBalanceMapper, AnsaSharedImplBillingDetailsMapper, AnsaSharedImplCustomerResponse, AnsaSharedImplCustomerResponseCurrentBalance, AnsaSharedImplCustomerResponseCurrentBalanceCompanion, AnsaSharedImplCustomerResponseBillingDetails, AnsaSharedImplCustomerResponseBillingDetailsCompanion, AnsaSharedImplCustomerResponseAnsaMetadata, AnsaSharedImplCustomerResponseAnsaMetadataCompanion, AnsaSharedImplCustomerResponseCompanion, AnsaSharedImplCustomerResponseSquare, AnsaSharedImplCustomerResponseSquareCompanion, AnsaSharedImplPaymentMethodMapper, AnsaSharedImplPaymentMethodsResponse, AnsaSharedImplPaymentMethodsResponseCompanion, AnsaSharedImplCardMapper, AnsaSharedImplAddPaymentMethodResponse, AnsaSharedImplAddPaymentMethodResponseCompanion, AnsaSharedImplAutoReloadConfigurationResponse, AnsaSharedImplAutoReloadConfigurationResponseCompanion, AnsaSharedImplBalanceMapper_, AnsaSharedImplAddBalanceResponse, AnsaSharedImplAddBalanceResponseCompanion, AnsaSharedImplUseBalanceResponse, AnsaSharedImplUseBalanceResponseCompanion, AnsaSharedImplUserReloadConfigurationResponse, AnsaSharedImplUserReloadConfigurationResponseCompanion, AnsaSharedImplPaymentMethodResponse, AnsaSharedImplPaymentMethodResponseCompanion, AnsaSharedImplCardResponse, AnsaSharedImplCardResponseCompanion, AnsaSharedImplCurrentBalance, AnsaSharedImplCurrentBalanceCompanion, AnsaSharedImplPresetReloadAmountResponse, AnsaSharedImplPresetReloadAmountResponseCompanion, AnsaSharedImplRealMerchantRepository, AnsaSharedImplMerchantMapper, AnsaSharedImplMerchantResponse, AnsaSharedImplMerchantResponseCompanion, AnsaSharedImplMetadataResponse, AnsaSharedImplMetadataResponseCompanion, AnsaSharedImplAppReloadConfigurationResponse, AnsaSharedImplAppReloadConfigurationResponseCompanion, AnsaSharedImplAutoReloadConfigResponse, AnsaSharedImplAutoReloadConfigResponseCompanion, AnsaSharedImplPromotionsResponse, AnsaSharedImplPromotionsResponseCompanion, AnsaSharedImplUserReferralConfigResponse, AnsaSharedImplUserReferralConfigResponseCompanion, AnsaSharedImplPresetReloadAmountResponse_, AnsaSharedImplPresetReloadAmountResponse_Companion, AnsaSharedImplRewardTierResponse, AnsaSharedImplRewardTierResponseCompanion, AnsaSharedKotlin_inject_runtimeLazyMap, AnsaSharedLogLevel, AnsaSharedAppReloadConfiguration, AnsaSharedMerchant, AnsaSharedMerchantAutoReloadConfiguration, AnsaSharedMerchantMetadata, AnsaSharedPresetReloadAmounts, AnsaSharedPromotions, AnsaSharedRewardTier, AnsaSharedUserReferralConfiguration, AnsaSharedApiResult<T>, AnsaSharedApiResultError, AnsaSharedApiResultErrorGenericError, AnsaSharedApiResultErrorHttpError, AnsaSharedApiResultErrorSerializationError, AnsaSharedApiResultSuccess<T>, AnsaSharedAuthTypeClientSecret, AnsaSharedAuthTypeNone, AnsaSharedAuthTypePublishableKey, AnsaSharedHttpErrorResponse, AnsaSharedHttpErrorResponseCompanion, AnsaSharedHttpExceptions, AnsaSharedKtorProvider, AnsaSharedKtorWrapper, AnsaSharedNetworkType, AnsaSharedNetworkTypeCompanion, AnsaSharedPaymentSession, AnsaSharedHttpClientHelpersKt, AnsaSharedKtor_client_coreResponseException, AnsaSharedKtor_client_coreHttpClient, AnsaSharedKtor_client_coreHttpResponse, AnsaSharedKtor_client_coreHttpRequestBuilder, AnsaSharedKtor_client_coreHttpRequestBuilderCompanion, AnsaSharedKtor_client_coreHttpClientEngineConfig, AnsaSharedKtor_client_coreHttpClientConfig<T>, AnsaSharedKtor_client_coreHttpReceivePipeline, AnsaSharedKtor_client_coreHttpReceivePipelinePhases, AnsaSharedKtor_client_coreHttpRequestPipeline, AnsaSharedKtor_client_coreHttpRequestPipelinePhases, AnsaSharedKtor_client_coreHttpResponsePipeline, AnsaSharedKtor_client_coreHttpResponsePipelinePhases, AnsaSharedKtor_client_coreHttpSendPipeline, AnsaSharedKtor_client_coreHttpSendPipelinePhases, AnsaSharedKtor_client_coreHttpClientCall, AnsaSharedKtor_client_coreHttpClientCallCompanion, AnsaSharedKtor_client_coreHttpRequestData, AnsaSharedKtor_client_coreHttpResponseData, AnsaSharedKtor_client_coreProxyConfig, AnsaSharedKtor_client_coreHttpResponseContainer, AnsaSharedGreeting, AnsaSharedIOSPlatform, AnsaSharedTestRepository, AnsaSharedPlatform_iosKt, AnsaSharedKtor_ioMemory, AnsaSharedKtor_ioMemoryCompanion, AnsaSharedKtor_ioChunkBuffer, AnsaSharedKtor_ioChunkBufferCompanion, AnsaSharedKtor_ioBuffer, AnsaSharedKtor_ioBufferCompanion, AnsaSharedKtor_ioByteReadPacket, AnsaSharedKtor_ioByteReadPacketCompanion, AnsaSharedKtor_ioInput, AnsaSharedKtor_ioInputCompanion, AnsaSharedKtor_httpHttpStatusCode, AnsaSharedKtor_httpHttpStatusCodeCompanion, AnsaSharedKtor_httpHttpProtocolVersion, AnsaSharedKtor_httpHttpProtocolVersionCompanion, AnsaSharedKtor_httpOutgoingContent, AnsaSharedKtor_httpOutgoingContentProtocolUpgrade, AnsaSharedKtor_httpOutgoingContentWriteChannelContent, AnsaSharedKtor_httpOutgoingContentByteArrayContent, AnsaSharedKtor_httpOutgoingContentNoContent, AnsaSharedKtor_httpOutgoingContentReadChannelContent, AnsaSharedKtor_httpHeadersBuilder, AnsaSharedKtor_httpURLBuilder, AnsaSharedKtor_httpURLBuilderCompanion, AnsaSharedKtor_httpHttpMethod, AnsaSharedKtor_httpHttpMethodCompanion, AnsaSharedKtor_httpUrl, AnsaSharedKtor_httpUrlCompanion, AnsaSharedKtor_httpContentType, AnsaSharedKtor_httpContentTypeCompanion, AnsaSharedKtor_httpHeaderValueWithParameters, AnsaSharedKtor_httpHeaderValueWithParametersCompanion, AnsaSharedKtor_httpURLProtocol, AnsaSharedKtor_httpURLProtocolCompanion, AnsaSharedKtor_httpHeaderValueParam, AnsaSharedKotlinx_serialization_corePolymorphicKind, AnsaSharedKotlinx_serialization_corePolymorphicKindOPEN, AnsaSharedKotlinx_serialization_corePolymorphicKindSEALED, AnsaSharedKotlinx_serialization_coreSerialKind, AnsaSharedKotlinx_serialization_coreSerialKindCONTEXTUAL, AnsaSharedKotlinx_serialization_coreSerialKindENUM, AnsaSharedKotlinx_serialization_corePrimitiveKind, AnsaSharedKotlinx_serialization_corePrimitiveKindBOOLEAN, AnsaSharedKotlinx_serialization_corePrimitiveKindBYTE, AnsaSharedKotlinx_serialization_corePrimitiveKindCHAR, AnsaSharedKotlinx_serialization_corePrimitiveKindDOUBLE, AnsaSharedKotlinx_serialization_corePrimitiveKindFLOAT, AnsaSharedKotlinx_serialization_corePrimitiveKindINT, AnsaSharedKotlinx_serialization_corePrimitiveKindLONG, AnsaSharedKotlinx_serialization_corePrimitiveKindSHORT, AnsaSharedKotlinx_serialization_corePrimitiveKindSTRING, AnsaSharedKotlinx_serialization_coreStructureKind, AnsaSharedKotlinx_serialization_coreStructureKindCLASS, AnsaSharedKotlinx_serialization_coreStructureKindLIST, AnsaSharedKotlinx_serialization_coreStructureKindMAP, AnsaSharedKotlinx_serialization_coreStructureKindOBJECT, AnsaSharedKotlinx_serialization_coreSerializersModule, AnsaSharedKtor_utilsPipeline<TSubject, TContext>, AnsaSharedKtor_utilsGMTDate, AnsaSharedKtor_utilsGMTDateCompanion, AnsaSharedKtor_utilsTypeInfo, AnsaSharedKtor_utilsAttributeKey<T>, AnsaSharedKtor_utilsStringValuesBuilderImpl, AnsaSharedKtor_utilsPipelinePhase, AnsaSharedKtor_utilsWeekDay, AnsaSharedKtor_utilsWeekDayCompanion, AnsaSharedKtor_utilsMonth, AnsaSharedKtor_utilsMonthCompanion, AnsaSharedKtor_eventsEvents, AnsaSharedKtor_eventsEventDefinition<T>, AnsaShared__SkieSuspendWrappersKt, AnsaShared__SkieTypeExportsKt, NSObject, NSError, NSString, NSArray<E>, NSMutableArray<E>, NSSet<E>, NSDictionary<K, V>, NSMutableSet, NSMutableDictionary, NSNumber;

@protocol AnsaSharedKotlinComparable, AnsaSharedKotlinCoroutineContext, AnsaSharedKotlinCoroutineContextElement, AnsaSharedKotlinCoroutineContextKey, AnsaSharedKotlinKClass, AnsaSharedKotlinKDeclarationContainer, AnsaSharedKotlinKAnnotatedElement, AnsaSharedKotlinKClassifier, AnsaSharedKotlinSuspendFunction1, AnsaSharedKotlinFunction, AnsaSharedKotlinAppendable, AnsaSharedKotlinSuspendFunction2, AnsaSharedKotlinIterator, AnsaSharedKotlinContinuationInterceptor, AnsaSharedKotlinMapEntry, AnsaSharedKotlinKType, AnsaSharedKotlinSequence, AnsaSharedKotlinIterable, AnsaSharedKotlinClosedRange, AnsaSharedKotlinOpenEndRange, AnsaSharedKotlinAnnotation, AnsaSharedKotlinContinuation, AnsaSharedSkie_DispatcherDelegate, AnsaSharedKotlinx_coroutines_coreFlow, AnsaSharedKotlinx_coroutines_coreMutableSharedFlow, AnsaSharedKotlinx_coroutines_coreSharedFlow, AnsaSharedKotlinx_coroutines_coreFlowCollector, AnsaSharedKotlinx_coroutines_coreMutableStateFlow, AnsaSharedKotlinx_coroutines_coreStateFlow, AnsaSharedKotlinx_coroutines_coreCoroutineScope, AnsaSharedKotlinx_coroutines_coreRunnable, AnsaSharedKotlinx_coroutines_coreJob, AnsaSharedKotlinx_coroutines_coreSelectClause1, AnsaSharedKotlinx_coroutines_coreSelectClause, AnsaSharedKotlinx_coroutines_coreSelectClause2, AnsaSharedKotlinx_coroutines_coreDisposableHandle, AnsaSharedKotlinx_coroutines_coreChildHandle, AnsaSharedKotlinx_coroutines_coreChildJob, AnsaSharedKotlinx_coroutines_coreSelectClause0, AnsaSharedKotlinx_coroutines_coreSelectInstance, AnsaSharedKotlinx_coroutines_coreParentJob, AnsaSharedCustomerRepository, AnsaSharedAutoReloadConfigurationStatus, AnsaSharedAddPaymentMethodTypeKmp, AnsaSharedKmpAppComponentBindings, AnsaSharedImplNetworkBindings, AnsaSharedImplCustomerBindings, AnsaSharedImplMerchantBindings, AnsaSharedKotlin_inject_runtimeScopedComponent, AnsaSharedAnsaLogger, AnsaSharedMerchantRepository, AnsaSharedAuthSessionManager, AnsaSharedAuthType, AnsaSharedClientSecretProviderIos, AnsaSharedKtor_client_coreClientPlugin, AnsaSharedKtor_client_coreHttpClientPlugin, AnsaSharedKtor_client_coreHttpClientEngine, AnsaSharedKtor_client_coreHttpClientEngineCapability, AnsaSharedKtor_client_coreHttpRequest, AnsaSharedPlatform, AnsaSharedKtor_ioCloseable, AnsaSharedKtor_ioByteReadChannel, AnsaSharedKtor_ioByteWriteChannel, AnsaSharedKtor_ioReadSession, AnsaSharedKtor_ioObjectPool, AnsaSharedKtor_httpHttpMessage, AnsaSharedKtor_httpHttpMessageBuilder, AnsaSharedKtor_httpHeaders, AnsaSharedKtor_httpParameters, AnsaSharedKtor_httpParametersBuilder, AnsaSharedKotlinx_serialization_coreKSerializer, AnsaSharedKotlinx_serialization_coreSerializationStrategy, AnsaSharedKotlinx_serialization_coreDeserializationStrategy, AnsaSharedKotlinx_serialization_coreEncoder, AnsaSharedKotlinx_serialization_coreSerialDescriptor, AnsaSharedKotlinx_serialization_coreDecoder, AnsaSharedKotlinx_serialization_coreCompositeEncoder, AnsaSharedKotlinx_serialization_coreCompositeDecoder, AnsaSharedKotlinx_serialization_coreSerializersModuleCollector, AnsaSharedKtor_utilsAttributes, AnsaSharedKtor_utilsStringValues, AnsaSharedKtor_utilsStringValuesBuilder, AnsaSharedImplMapper, NSCopying;
...
__attribute__((swift_name("ImplNetworkBindings")))
@protocol AnsaSharedImplNetworkBindings
@required
- (id<AnsaSharedAuthSessionManager>)bind:(AnsaSharedImplRealAuthSessionManager *)receiver __attribute__((swift_name("bind(_:)")));
...
__attribute__((swift_name("ImplCustomerBindings")))
@protocol AnsaSharedImplCustomerBindings
@required
- (id<AnsaSharedCustomerRepository>)bind_:(AnsaSharedImplRealCustomerRepository *)receiver __attribute__((swift_name("bind(__:)")));
@property (readonly) id<AnsaSharedCustomerRepository> customerRepository __attribute__((swift_name("customerRepository")));
@end

__attribute__((swift_name("ImplMerchantBindings")))
@protocol AnsaSharedImplMerchantBindings
@required
- (id<AnsaSharedMerchantRepository>)bind__:(AnsaSharedImplRealMerchantRepository *)receiver __attribute__((swift_name("bind(___:)")));
...
@protocol AnsaSharedKmpAppComponentBindings <AnsaSharedImplNetworkBindings, AnsaSharedImplCustomerBindings, AnsaSharedImplMerchantBindings>
@required
@end
...
@interface AnsaSharedGreeting : AnsaSharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)greet __attribute__((swift_name("greet()")));
- (void)printGreeting __attribute__((swift_name("printGreeting()")));
- (void)testUpdatedGreeting __attribute__((swift_name("testUpdatedGreeting()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)trySuspendFunWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("trySuspendFun(completionHandler:)")));
@end

__attribute__((swift_name("Platform")))
@protocol AnsaSharedPlatform
@required
@property (readonly) NSString *name __attribute__((swift_name("name")));
@end
...
@interface AnsaSharedIOSPlatform : AnsaSharedBase <AnsaSharedPlatform>
@property (readonly) NSString *name __attribute__((swift_name("name")));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end
...
@interface AnsaSharedTestRepository : AnsaSharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)addUserBalance __attribute__((swift_name("addUserBalance()")));
@end
...
@interface AnsaSharedPlatform_iosKt : AnsaSharedBase
+ (id<AnsaSharedPlatform>)getPlatform __attribute__((swift_name("getPlatform()")));
@end
...
+ (void)Skie_Suspend__10__getReloadConfigDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver customerId:(NSString *)customerId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__10__getReloadConfig(dispatchReceiver:customerId:suspendHandler:)")));
+ (void)Skie_Suspend__11__setAutoReloadConfigurationDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver request:(AnsaSharedAutoReloadConfigurationRequest *)request idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__11__setAutoReloadConfiguration(dispatchReceiver:request:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__12__useBalanceDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver request:(AnsaSharedUseBalanceRequest *)request idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__12__useBalance(dispatchReceiver:request:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__13__getMerchantDispatchReceiver:(id<AnsaSharedMerchantRepository>)dispatchReceiver merchantId:(NSString *)merchantId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__13__getMerchant(dispatchReceiver:merchantId:suspendHandler:)")));
+ (void)Skie_Suspend__14__getValidSessionOrNullDispatchReceiver:(id<AnsaSharedAuthSessionManager>)dispatchReceiver ansaCustomerId:(NSString *)ansaCustomerId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__14__getValidSessionOrNull(dispatchReceiver:ansaCustomerId:suspendHandler:)")));
+ (void)Skie_Suspend__15__refreshSessionDispatchReceiver:(id<AnsaSharedAuthSessionManager>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__15__refreshSession(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__1__hasNextDispatchReceiver:(AnsaSharedSkieColdFlowIterator<id> *)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__1__hasNext(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__22__trySuspendFunDispatchReceiver:(AnsaSharedGreeting *)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__22__trySuspendFun(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__23__executeDispatchReceiver:(id<AnsaSharedKtor_client_coreHttpClientEngine>)dispatchReceiver data:(AnsaSharedKtor_client_coreHttpRequestData *)data suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__23__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__24__executeDispatchReceiver:(AnsaSharedKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__24__execute(dispatchReceiver:context:subject:suspendHandler:)")));
...
+ (void)Skie_Suspend__3__emitDispatchReceiver:(id<AnsaSharedKotlinx_coroutines_coreFlowCollector>)dispatchReceiver value:(id _Nullable)value suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__emit(dispatchReceiver:value:suspendHandler:)")));
...
+ (void)Skie_Suspend__51__upgradeDispatchReceiver:(AnsaSharedKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<AnsaSharedKtor_ioByteReadChannel>)input output:(id<AnsaSharedKtor_ioByteWriteChannel>)output engineContext:(id<AnsaSharedKotlinCoroutineContext>)engineContext userContext:(id<AnsaSharedKotlinCoroutineContext>)userContext suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__52__writeToDispatchReceiver:(AnsaSharedKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<AnsaSharedKtor_ioByteWriteChannel>)channel suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__53__joinDispatchReceiver:(id<AnsaSharedKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__54__invokeDispatchReceiver:(id<AnsaSharedKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
...
+ (void)Skie_Suspend__56__awaitFreeSpaceDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__57__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKtor_ioChunkBuffer *)src suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
...
+ (void)Skie_Suspend__5__addPaymentMethodDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver customerId:(NSString *)customerId paymentMethodType:(id<AnsaSharedAddPaymentMethodTypeKmp>)paymentMethodType idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__5__addPaymentMethod(dispatchReceiver:customerId:paymentMethodType:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__60__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__61__writeByteDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__62__writeDoubleDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__63__writeFloatDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__64__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver memory:(AnsaSharedKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__65__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKtor_ioBuffer *)src suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__writeFully(dispatchReceiver:src:suspendHandler:)")));
...
+ (void)Skie_Suspend__69__writeIntDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__6__deletePaymentMethodDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver customerId:(NSString *)customerId paymentMethodId:(NSString *)paymentMethodId idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__deletePaymentMethod(dispatchReceiver:customerId:paymentMethodId:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__70__writeLongDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__71__writePacketDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver packet:(AnsaSharedKtor_ioByteReadPacket *)packet suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__72__writeShortDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__73__writeSuspendSessionDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<AnsaSharedKotlinSuspendFunction1>)visitor suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__74__deleteResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__deleteResult(extensionReceiver:resource:builder:suspendHandler:)")));
+ (void)Skie_Suspend__75__getResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__getResult(extensionReceiver:resource:builder:suspendHandler:)")));
+ (void)Skie_Suspend__76__postResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource body:(id _Nullable)body builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__postResult(extensionReceiver:resource:body:builder:suspendHandler:)")));
+ (void)Skie_Suspend__77__postResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver url:(NSString *)url body:(id _Nullable)body builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__postResult(extensionReceiver:url:body:builder:suspendHandler:)")));
+ (void)Skie_Suspend__78__safeBodyExtensionReceiver:(AnsaSharedKtor_client_coreHttpResponse *)extensionReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__safeBody(extensionReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__7__getAutoReloadConfigurationDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver customerId:(NSString *)customerId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__7__getAutoReloadConfiguration(dispatchReceiver:customerId:suspendHandler:)")));
+ (void)Skie_Suspend__8__getCustomerDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver customerId:(NSString *)customerId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__8__getCustomer(dispatchReceiver:customerId:suspendHandler:)")));
+ (void)Skie_Suspend__9__getPaymentMethodsDispatchReceiver:(id<AnsaSharedCustomerRepository>)dispatchReceiver customerId:(NSString *)customerId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__9__getPaymentMethods(dispatchReceiver:customerId:suspendHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("__SkieTypeExportsKt")))
@interface AnsaShared__SkieTypeExportsKt : AnsaSharedBase
+ (void)skieTypeExports_0P0:(AnsaSharedKotlinx_serialization_corePolymorphicKind *)p0 p1:(AnsaSharedKotlinx_serialization_corePrimitiveKind *)p1 p2:(AnsaSharedKotlinx_serialization_coreSerialKindCONTEXTUAL *)p2 p3:(AnsaSharedKotlinx_serialization_coreSerialKindENUM *)p3 p4:(AnsaSharedKotlinx_serialization_coreStructureKind *)p4 p5:(AnsaSharedKotlinx_serialization_corePolymorphicKindOPEN *)p5 p6:(AnsaSharedKotlinx_serialization_corePolymorphicKindSEALED *)p6 p7:(AnsaSharedKotlinx_serialization_corePrimitiveKindBOOLEAN *)p7 p8:(AnsaSharedKotlinx_serialization_corePrimitiveKindBYTE *)p8 p9:(AnsaSharedKotlinx_serialization_corePrimitiveKindCHAR *)p9 p10:(AnsaSharedKotlinx_serialization_corePrimitiveKindDOUBLE *)p10 p11:(AnsaSharedKotlinx_serialization_corePrimitiveKindFLOAT *)p11 p12:(AnsaSharedKotlinx_serialization_corePrimitiveKindINT *)p12 p13:(AnsaSharedKotlinx_serialization_corePrimitiveKindLONG *)p13 p14:(AnsaSharedKotlinx_serialization_corePrimitiveKindSHORT *)p14 p15:(AnsaSharedKotlinx_serialization_corePrimitiveKindSTRING *)p15 p16:(AnsaSharedKotlinx_serialization_coreStructureKindCLASS *)p16 p17:(AnsaSharedKotlinx_serialization_coreStructureKindLIST *)p17 p18:(AnsaSharedKotlinx_serialization_coreStructureKindMAP *)p18 p19:(AnsaSharedKotlinx_serialization_coreStructureKindOBJECT *)p19 p20:(AnsaSharedKtor_httpOutgoingContentByteArrayContent *)p20 p21:(AnsaSharedKtor_httpOutgoingContentNoContent *)p21 p22:(AnsaSharedKtor_httpOutgoingContentProtocolUpgrade *)p22 p23:(AnsaSharedKtor_httpOutgoingContentReadChannelContent *)p23 p24:(AnsaSharedKtor_httpOutgoingContentWriteChannelContent *)p24 p25:(id<AnsaSharedKotlinx_coroutines_coreSelectClause1>)p25 p26:(id<AnsaSharedKotlinx_coroutines_coreSelectClause2>)p26 __attribute__((swift_name("skieTypeExports_0(p0:p1:p2:p3:p4:p5:p6:p7:p8:p9:p10:p11:p12:p13:p14:p15:p16:p17:p18:p19:p20:p21:p22:p23:p24:p25:p26:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplRealAuthSessionManager")))
@interface AnsaSharedImplRealAuthSessionManager : AnsaSharedBase <AnsaSharedAuthSessionManager>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplRealCustomerRepository")))
@interface AnsaSharedImplRealCustomerRepository : AnsaSharedBase <AnsaSharedCustomerRepository>
- (instancetype)initWithKtorWrapper:(AnsaSharedKtorWrapper *)ktorWrapper networkType:(AnsaSharedNetworkType *)networkType customerMapper:(AnsaSharedImplCustomerMapper *)customerMapper paymentMethodListMapper:(AnsaSharedImplPaymentMethodListMapper *)paymentMethodListMapper addPaymentMethodMapper:(AnsaSharedImplAddPaymentMethodMapper *)addPaymentMethodMapper autoReloadConfigMapper:(AnsaSharedImplAutoReloadConfigMapper *)autoReloadConfigMapper addBalanceMapper:(AnsaSharedImplAddBalanceMapper *)addBalanceMapper useBalanceMapper:(AnsaSharedImplUseBalanceMapper *)useBalanceMapper userReloadConfigurationMapper:(AnsaSharedImplUserReloadConfigurationMapper *)userReloadConfigurationMapper __attribute__((swift_name("init(ktorWrapper:networkType:customerMapper:paymentMethodListMapper:addPaymentMethodMapper:autoReloadConfigMapper:addBalanceMapper:useBalanceMapper:userReloadConfigurationMapper:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplRealMerchantRepository")))
@interface AnsaSharedImplRealMerchantRepository : AnsaSharedBase <AnsaSharedMerchantRepository>
- (instancetype)initWithKtorWrapper:(AnsaSharedKtorWrapper *)ktorWrapper merchantMapper:(AnsaSharedImplMerchantMapper *)merchantMapper __attribute__((swift_name("init(ktorWrapper:merchantMapper:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("ImplMapper")))
@protocol AnsaSharedImplMapper
@required
- (id _Nullable)mapFrom:(id _Nullable)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerMapper")))
@interface AnsaSharedImplCustomerMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)initWithBalanceMapper:(AnsaSharedImplBalanceMapper *)balanceMapper billingDetailsMapper:(AnsaSharedImplBillingDetailsMapper *)billingDetailsMapper paymentMethodListMapper:(AnsaSharedImplPaymentMethodListMapper *)paymentMethodListMapper autoReloadConfigMapper:(AnsaSharedImplAutoReloadConfigMapper *)autoReloadConfigMapper __attribute__((swift_name("init(balanceMapper:billingDetailsMapper:paymentMethodListMapper:autoReloadConfigMapper:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedCustomer *)mapFrom:(AnsaSharedImplCustomerResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPaymentMethodListMapper")))
@interface AnsaSharedImplPaymentMethodListMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)initWithMethodMapper:(AnsaSharedImplPaymentMethodMapper *)methodMapper __attribute__((swift_name("init(methodMapper:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedPaymentMethodCollection *)mapFrom:(AnsaSharedImplPaymentMethodsResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAddPaymentMethodMapper")))
@interface AnsaSharedImplAddPaymentMethodMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)initWithCardMapper:(AnsaSharedImplCardMapper *)cardMapper __attribute__((swift_name("init(cardMapper:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedPaymentMethod *)mapFrom:(AnsaSharedImplAddPaymentMethodResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAutoReloadConfigMapper")))
@interface AnsaSharedImplAutoReloadConfigMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedAutoReloadConfiguration * _Nullable)mapFrom:(AnsaSharedImplAutoReloadConfigurationResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAddBalanceMapper")))
@interface AnsaSharedImplAddBalanceMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)initWithBalanceMapper:(AnsaSharedImplBalanceMapper_ *)balanceMapper __attribute__((swift_name("init(balanceMapper:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedBalanceUpdate *)mapFrom:(AnsaSharedImplAddBalanceResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUseBalanceMapper")))
@interface AnsaSharedImplUseBalanceMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)initWithBalanceMapper:(AnsaSharedImplBalanceMapper_ *)balanceMapper __attribute__((swift_name("init(balanceMapper:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedBalanceUpdate *)mapFrom:(AnsaSharedImplUseBalanceResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUserReloadConfigurationMapper")))
@interface AnsaSharedImplUserReloadConfigurationMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedUserReloadConfiguration *)mapFrom:(AnsaSharedImplUserReloadConfigurationResponse *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplMerchantMapper")))
@interface AnsaSharedImplMerchantMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedMerchant *)mapFrom:(AnsaSharedImplMerchantResponse *)from __attribute__((swift_name("map(from:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplBalanceMapper")))
@interface AnsaSharedImplBalanceMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedBalance *)mapFrom:(AnsaSharedImplCustomerResponseCurrentBalance *)from __attribute__((swift_name("map(from:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplBillingDetailsMapper")))
@interface AnsaSharedImplBillingDetailsMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedBillingDetails *)mapFrom:(AnsaSharedImplCustomerResponseBillingDetails *)from __attribute__((swift_name("map(from:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse")))
@interface AnsaSharedImplCustomerResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCustomerResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) AnsaSharedImplCustomerResponseAnsaMetadata *ansaMetadata __attribute__((swift_name("ansaMetadata")));
@property (readonly) AnsaSharedImplAutoReloadConfigurationResponse * _Nullable autoReloadConfig __attribute__((swift_name("autoReloadConfig")));
@property (readonly) AnsaSharedImplCustomerResponseCurrentBalance *balance __attribute__((swift_name("balance")));
@property (readonly) AnsaSharedImplCustomerResponseBillingDetails *billingDetails __attribute__((swift_name("billingDetails")));
@property (readonly) NSString * _Nullable email __attribute__((swift_name("email")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *merchantID __attribute__((swift_name("merchantID")));
@property (readonly) AnsaSharedImplPaymentMethodsResponse * _Nullable paymentMethods __attribute__((swift_name("paymentMethods")));
@property (readonly) NSString * _Nullable phone __attribute__((swift_name("phone")));
@property (readonly) NSString *status __attribute__((swift_name("status")));
- (instancetype)initWithId:(NSString *)id ansaMetadata:(AnsaSharedImplCustomerResponseAnsaMetadata *)ansaMetadata balance:(AnsaSharedImplCustomerResponseCurrentBalance *)balance billingDetails:(AnsaSharedImplCustomerResponseBillingDetails *)billingDetails email:(NSString * _Nullable)email merchantID:(NSString *)merchantID phone:(NSString * _Nullable)phone status:(NSString *)status autoReloadConfig:(AnsaSharedImplAutoReloadConfigurationResponse * _Nullable)autoReloadConfig paymentMethods:(AnsaSharedImplPaymentMethodsResponse * _Nullable)paymentMethods __attribute__((swift_name("init(id:ansaMetadata:balance:billingDetails:email:merchantID:phone:status:autoReloadConfig:paymentMethods:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplCustomerResponse *)doCopyId:(NSString *)id ansaMetadata:(AnsaSharedImplCustomerResponseAnsaMetadata *)ansaMetadata balance:(AnsaSharedImplCustomerResponseCurrentBalance *)balance billingDetails:(AnsaSharedImplCustomerResponseBillingDetails *)billingDetails email:(NSString * _Nullable)email merchantID:(NSString *)merchantID phone:(NSString * _Nullable)phone status:(NSString *)status autoReloadConfig:(AnsaSharedImplAutoReloadConfigurationResponse * _Nullable)autoReloadConfig paymentMethods:(AnsaSharedImplPaymentMethodsResponse * _Nullable)paymentMethods __attribute__((swift_name("doCopy(id:ansaMetadata:balance:billingDetails:email:merchantID:phone:status:autoReloadConfig:paymentMethods:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPaymentMethodMapper")))
@interface AnsaSharedImplPaymentMethodMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)initWithCardMapper:(AnsaSharedImplCardMapper *)cardMapper __attribute__((swift_name("init(cardMapper:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedPaymentMethod *)mapFrom:(AnsaSharedImplPaymentMethodResponse *)from __attribute__((swift_name("map(from:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPaymentMethodsResponse")))
@interface AnsaSharedImplPaymentMethodsResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplPaymentMethodsResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t count __attribute__((swift_name("count")));
@property (readonly) NSArray<AnsaSharedImplPaymentMethodResponse *> *paymentMethods __attribute__((swift_name("paymentMethods")));
- (instancetype)initWithCount:(int32_t)count paymentMethods:(NSArray<AnsaSharedImplPaymentMethodResponse *> *)paymentMethods __attribute__((swift_name("init(count:paymentMethods:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplPaymentMethodsResponse *)doCopyCount:(int32_t)count paymentMethods:(NSArray<AnsaSharedImplPaymentMethodResponse *> *)paymentMethods __attribute__((swift_name("doCopy(count:paymentMethods:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCardMapper")))
@interface AnsaSharedImplCardMapper : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedCard *)mapFrom:(AnsaSharedImplCardResponse *)from __attribute__((swift_name("map(from:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAddPaymentMethodResponse")))
@interface AnsaSharedImplAddPaymentMethodResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplAddPaymentMethodResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) AnsaSharedImplCardResponse *card __attribute__((swift_name("card")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) AnsaSharedBoolean * _Nullable preferred __attribute__((swift_name("preferred")));
@property (readonly) NSString *type __attribute__((swift_name("type")));
- (instancetype)initWithCard:(AnsaSharedImplCardResponse *)card id:(NSString *)id preferred:(AnsaSharedBoolean * _Nullable)preferred type:(NSString *)type __attribute__((swift_name("init(card:id:preferred:type:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplAddPaymentMethodResponse *)doCopyCard:(AnsaSharedImplCardResponse *)card id:(NSString *)id preferred:(AnsaSharedBoolean * _Nullable)preferred type:(NSString *)type __attribute__((swift_name("doCopy(card:id:preferred:type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAutoReloadConfigurationResponse")))
@interface AnsaSharedImplAutoReloadConfigurationResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplAutoReloadConfigurationResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) BOOL enabled __attribute__((swift_name("enabled")));
...
- (AnsaSharedImplAutoReloadConfigurationResponse *)doCopyEnabled:(BOOL)enabled paymentMethodId:(NSString * _Nullable)paymentMethodId reloadAmount:(AnsaSharedInt * _Nullable)reloadAmount reloadThreshold:(AnsaSharedInt * _Nullable)reloadThreshold __attribute__((swift_name("doCopy(enabled:paymentMethodId:reloadAmount:reloadThreshold:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplBalanceMapper_")))
@interface AnsaSharedImplBalanceMapper_ : AnsaSharedBase <AnsaSharedImplMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedBalance *)mapFrom:(AnsaSharedImplCurrentBalance *)from __attribute__((swift_name("map(from:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAddBalanceResponse")))
@interface AnsaSharedImplAddBalanceResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplAddBalanceResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) AnsaSharedImplCurrentBalance *currentBalance __attribute__((swift_name("currentBalance")));
@property (readonly) NSString * _Nullable label __attribute__((swift_name("label")));
@property (readonly) NSString *timestamp __attribute__((swift_name("timestamp")));
@property (readonly) NSString *transactionId __attribute__((swift_name("transactionId")));
- (instancetype)initWithCurrentBalance:(AnsaSharedImplCurrentBalance *)currentBalance label:(NSString * _Nullable)label timestamp:(NSString *)timestamp transactionId:(NSString *)transactionId __attribute__((swift_name("init(currentBalance:label:timestamp:transactionId:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplAddBalanceResponse *)doCopyCurrentBalance:(AnsaSharedImplCurrentBalance *)currentBalance label:(NSString * _Nullable)label timestamp:(NSString *)timestamp transactionId:(NSString *)transactionId __attribute__((swift_name("doCopy(currentBalance:label:timestamp:transactionId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUseBalanceResponse")))
@interface AnsaSharedImplUseBalanceResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplUseBalanceResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) AnsaSharedImplCurrentBalance *currentBalance __attribute__((swift_name("currentBalance")));
@property (readonly) NSString * _Nullable label __attribute__((swift_name("label")));
@property (readonly) NSString *timestamp __attribute__((swift_name("timestamp")));
@property (readonly) NSString *transactionId __attribute__((swift_name("transactionId")));
- (instancetype)initWithCurrentBalance:(AnsaSharedImplCurrentBalance *)currentBalance label:(NSString * _Nullable)label timestamp:(NSString *)timestamp transactionId:(NSString *)transactionId __attribute__((swift_name("init(currentBalance:label:timestamp:transactionId:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplUseBalanceResponse *)doCopyCurrentBalance:(AnsaSharedImplCurrentBalance *)currentBalance label:(NSString * _Nullable)label timestamp:(NSString *)timestamp transactionId:(NSString *)transactionId __attribute__((swift_name("doCopy(currentBalance:label:timestamp:transactionId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUserReloadConfigurationResponse")))
@interface AnsaSharedImplUserReloadConfigurationResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplUserReloadConfigurationResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) BOOL allowCustomAmount __attribute__((swift_name("allowCustomAmount")));
@property (readonly) NSArray<AnsaSharedImplPresetReloadAmountResponse *> *presetAmounts __attribute__((swift_name("presetAmounts")));
- (instancetype)initWithAllowCustomAmount:(BOOL)allowCustomAmount presetAmounts:(NSArray<AnsaSharedImplPresetReloadAmountResponse *> *)presetAmounts __attribute__((swift_name("init(allowCustomAmount:presetAmounts:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplUserReloadConfigurationResponse *)doCopyAllowCustomAmount:(BOOL)allowCustomAmount presetAmounts:(NSArray<AnsaSharedImplPresetReloadAmountResponse *> *)presetAmounts __attribute__((swift_name("doCopy(allowCustomAmount:presetAmounts:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplMerchantResponse")))
@interface AnsaSharedImplMerchantResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplMerchantResponseCompanion *companion __attribute__((swift_name("companion")));
@property NSString *id __attribute__((swift_name("id")));
@property AnsaSharedImplMetadataResponse *metadata __attribute__((swift_name("metadata")));
@property NSString *name __attribute__((swift_name("name")));
- (instancetype)initWithId:(NSString *)id name:(NSString *)name metadata:(AnsaSharedImplMetadataResponse *)metadata __attribute__((swift_name("init(id:name:metadata:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplMerchantResponse *)doCopyId:(NSString *)id name:(NSString *)name metadata:(AnsaSharedImplMetadataResponse *)metadata __attribute__((swift_name("doCopy(id:name:metadata:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.CurrentBalance")))
@interface AnsaSharedImplCustomerResponseCurrentBalance : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCustomerResponseCurrentBalanceCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int64_t amount __attribute__((swift_name("amount")));
@property (readonly) NSString *currency __attribute__((swift_name("currency")));
- (instancetype)initWithAmount:(int64_t)amount currency:(NSString *)currency __attribute__((swift_name("init(amount:currency:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplCustomerResponseCurrentBalance *)doCopyAmount:(int64_t)amount currency:(NSString *)currency __attribute__((swift_name("doCopy(amount:currency:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.BillingDetails")))
@interface AnsaSharedImplCustomerResponseBillingDetails : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCustomerResponseBillingDetailsCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *firstName __attribute__((swift_name("firstName")));
@property (readonly) NSString *lastName __attribute__((swift_name("lastName")));
- (instancetype)initWithFirstName:(NSString *)firstName lastName:(NSString *)lastName __attribute__((swift_name("init(firstName:lastName:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplCustomerResponseBillingDetails *)doCopyFirstName:(NSString *)firstName lastName:(NSString *)lastName __attribute__((swift_name("doCopy(firstName:lastName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.AnsaMetadata")))
@interface AnsaSharedImplCustomerResponseAnsaMetadata : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCustomerResponseAnsaMetadataCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *referralCode __attribute__((swift_name("referralCode")));
@property (readonly) AnsaSharedImplCustomerResponseSquare *square __attribute__((swift_name("square")));
@property (readonly) AnsaSharedImplCustomerResponseSquare *stripe __attribute__((swift_name("stripe")));
- (instancetype)initWithReferralCode:(NSString *)referralCode square:(AnsaSharedImplCustomerResponseSquare *)square stripe:(AnsaSharedImplCustomerResponseSquare *)stripe __attribute__((swift_name("init(referralCode:square:stripe:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplCustomerResponseAnsaMetadata *)doCopyReferralCode:(NSString *)referralCode square:(AnsaSharedImplCustomerResponseSquare *)square stripe:(AnsaSharedImplCustomerResponseSquare *)stripe __attribute__((swift_name("doCopy(referralCode:square:stripe:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.Companion")))
@interface AnsaSharedImplCustomerResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCustomerResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPaymentMethodResponse")))
@interface AnsaSharedImplPaymentMethodResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplPaymentMethodResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) AnsaSharedImplCardResponse *card __attribute__((swift_name("card")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *type __attribute__((swift_name("type")));
- (instancetype)initWithCard:(AnsaSharedImplCardResponse *)card id:(NSString *)id type:(NSString *)type __attribute__((swift_name("init(card:id:type:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplPaymentMethodResponse *)doCopyCard:(AnsaSharedImplCardResponse *)card id:(NSString *)id type:(NSString *)type __attribute__((swift_name("doCopy(card:id:type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPaymentMethodsResponse.Companion")))
@interface AnsaSharedImplPaymentMethodsResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplPaymentMethodsResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCardResponse")))
@interface AnsaSharedImplCardResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCardResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *brand __attribute__((swift_name("brand")));
@property (readonly) NSString *fingerprint __attribute__((swift_name("fingerprint")));
@property (readonly) NSString *firstSix __attribute__((swift_name("firstSix")));
@property (readonly) NSString *lastFour __attribute__((swift_name("lastFour")));
- (instancetype)initWithBrand:(NSString *)brand fingerprint:(NSString *)fingerprint firstSix:(NSString *)firstSix lastFour:(NSString *)lastFour __attribute__((swift_name("init(brand:fingerprint:firstSix:lastFour:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplCardResponse *)doCopyBrand:(NSString *)brand fingerprint:(NSString *)fingerprint firstSix:(NSString *)firstSix lastFour:(NSString *)lastFour __attribute__((swift_name("doCopy(brand:fingerprint:firstSix:lastFour:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAddPaymentMethodResponse.Companion")))
@interface AnsaSharedImplAddPaymentMethodResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplAddPaymentMethodResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAutoReloadConfigurationResponse.Companion")))
@interface AnsaSharedImplAutoReloadConfigurationResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplAutoReloadConfigurationResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCurrentBalance")))
@interface AnsaSharedImplCurrentBalance : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCurrentBalanceCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int64_t amount __attribute__((swift_name("amount")));
@property (readonly) NSString *currency __attribute__((swift_name("currency")));
- (instancetype)initWithAmount:(int64_t)amount currency:(NSString *)currency __attribute__((swift_name("init(amount:currency:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplCurrentBalance *)doCopyAmount:(int64_t)amount currency:(NSString *)currency __attribute__((swift_name("doCopy(amount:currency:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAddBalanceResponse.Companion")))
@interface AnsaSharedImplAddBalanceResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplAddBalanceResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUseBalanceResponse.Companion")))
@interface AnsaSharedImplUseBalanceResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplUseBalanceResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPresetReloadAmountResponse")))
@interface AnsaSharedImplPresetReloadAmountResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplPresetReloadAmountResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t amount __attribute__((swift_name("amount")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) BOOL isMostPopular __attribute__((swift_name("isMostPopular")));
@property (readonly) int32_t promotionAmount __attribute__((swift_name("promotionAmount")));
- (instancetype)initWithId:(NSString *)id amount:(int32_t)amount promotionAmount:(int32_t)promotionAmount isMostPopular:(BOOL)isMostPopular __attribute__((swift_name("init(id:amount:promotionAmount:isMostPopular:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplPresetReloadAmountResponse *)doCopyId:(NSString *)id amount:(int32_t)amount promotionAmount:(int32_t)promotionAmount isMostPopular:(BOOL)isMostPopular __attribute__((swift_name("doCopy(id:amount:promotionAmount:isMostPopular:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUserReloadConfigurationResponse.Companion")))
@interface AnsaSharedImplUserReloadConfigurationResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplUserReloadConfigurationResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplMetadataResponse")))
@interface AnsaSharedImplMetadataResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplMetadataResponseCompanion *companion __attribute__((swift_name("companion")));
@property AnsaSharedImplAppReloadConfigurationResponse *appReloadConfig __attribute__((swift_name("appReloadConfig")));
@property AnsaSharedImplAutoReloadConfigResponse *autoReloadConfig __attribute__((swift_name("autoReloadConfig")));
...
@property AnsaSharedImplPromotionsResponse *promotions __attribute__((swift_name("promotions")));
@property AnsaSharedImplUserReferralConfigResponse *userReferralConfig __attribute__((swift_name("userReferralConfig")));
- (instancetype)initWithAppReloadConfig:(AnsaSharedImplAppReloadConfigurationResponse *)appReloadConfig autoReloadConfig:(AnsaSharedImplAutoReloadConfigResponse *)autoReloadConfig omsProvider:(NSString * _Nullable)omsProvider paymentProcessor:(NSString * _Nullable)paymentProcessor promotions:(AnsaSharedImplPromotionsResponse *)promotions userReferralConfig:(AnsaSharedImplUserReferralConfigResponse *)userReferralConfig __attribute__((swift_name("init(appReloadConfig:autoReloadConfig:omsProvider:paymentProcessor:promotions:userReferralConfig:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplMetadataResponse *)doCopyAppReloadConfig:(AnsaSharedImplAppReloadConfigurationResponse *)appReloadConfig autoReloadConfig:(AnsaSharedImplAutoReloadConfigResponse *)autoReloadConfig omsProvider:(NSString * _Nullable)omsProvider paymentProcessor:(NSString * _Nullable)paymentProcessor promotions:(AnsaSharedImplPromotionsResponse *)promotions userReferralConfig:(AnsaSharedImplUserReferralConfigResponse *)userReferralConfig __attribute__((swift_name("doCopy(appReloadConfig:autoReloadConfig:omsProvider:paymentProcessor:promotions:userReferralConfig:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplMerchantResponse.Companion")))
@interface AnsaSharedImplMerchantResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplMerchantResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.CurrentBalanceCompanion")))
@interface AnsaSharedImplCustomerResponseCurrentBalanceCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCustomerResponseCurrentBalanceCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.BillingDetailsCompanion")))
@interface AnsaSharedImplCustomerResponseBillingDetailsCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCustomerResponseBillingDetailsCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.Square")))
@interface AnsaSharedImplCustomerResponseSquare : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplCustomerResponseSquareCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *customerID __attribute__((swift_name("customerID")));
...
- (AnsaSharedImplCustomerResponseSquare *)doCopyCustomerID:(NSString *)customerID __attribute__((swift_name("doCopy(customerID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.AnsaMetadataCompanion")))
@interface AnsaSharedImplCustomerResponseAnsaMetadataCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCustomerResponseAnsaMetadataCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPaymentMethodResponse.Companion")))
@interface AnsaSharedImplPaymentMethodResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplPaymentMethodResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCardResponse.Companion")))
@interface AnsaSharedImplCardResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCardResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCurrentBalance.Companion")))
@interface AnsaSharedImplCurrentBalanceCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCurrentBalanceCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPresetReloadAmountResponse.Companion")))
@interface AnsaSharedImplPresetReloadAmountResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplPresetReloadAmountResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAppReloadConfigurationResponse")))
@interface AnsaSharedImplAppReloadConfigurationResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplAppReloadConfigurationResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) BOOL allowCustomAmount __attribute__((swift_name("allowCustomAmount")));
@property (readonly) NSArray<AnsaSharedImplPresetReloadAmountResponse_ *> *presetAmounts __attribute__((swift_name("presetAmounts")));
- (instancetype)initWithAllowCustomAmount:(BOOL)allowCustomAmount presetAmounts:(NSArray<AnsaSharedImplPresetReloadAmountResponse_ *> *)presetAmounts __attribute__((swift_name("init(allowCustomAmount:presetAmounts:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplAppReloadConfigurationResponse *)doCopyAllowCustomAmount:(BOOL)allowCustomAmount presetAmounts:(NSArray<AnsaSharedImplPresetReloadAmountResponse_ *> *)presetAmounts __attribute__((swift_name("doCopy(allowCustomAmount:presetAmounts:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAutoReloadConfigResponse")))
@interface AnsaSharedImplAutoReloadConfigResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplAutoReloadConfigResponseCompanion *companion __attribute__((swift_name("companion")));
...
- (instancetype)initWithMaximumAutoReloadAmount:(int32_t)maximumAutoReloadAmount minimumAutoReloadAmount:(int32_t)minimumAutoReloadAmount minimumAutoReloadThreshold:(int32_t)minimumAutoReloadThreshold __attribute__((swift_name("init(maximumAutoReloadAmount:minimumAutoReloadAmount:minimumAutoReloadThreshold:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplAutoReloadConfigResponse *)doCopyMaximumAutoReloadAmount:(int32_t)maximumAutoReloadAmount minimumAutoReloadAmount:(int32_t)minimumAutoReloadAmount minimumAutoReloadThreshold:(int32_t)minimumAutoReloadThreshold __attribute__((swift_name("doCopy(maximumAutoReloadAmount:minimumAutoReloadAmount:minimumAutoReloadThreshold:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPromotionsResponse")))
@interface AnsaSharedImplPromotionsResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplPromotionsResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSArray<AnsaSharedImplRewardTierResponse *> *tiers __attribute__((swift_name("tiers")));
@property (readonly) NSString *type __attribute__((swift_name("type")));
- (instancetype)initWithTiers:(NSArray<AnsaSharedImplRewardTierResponse *> *)tiers type:(NSString *)type __attribute__((swift_name("init(tiers:type:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplPromotionsResponse *)doCopyTiers:(NSArray<AnsaSharedImplRewardTierResponse *> *)tiers type:(NSString *)type __attribute__((swift_name("doCopy(tiers:type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUserReferralConfigResponse")))
@interface AnsaSharedImplUserReferralConfigResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplUserReferralConfigResponseCompanion *companion __attribute__((swift_name("companion")));
...
- (instancetype)initWithEnabled:(BOOL)enabled recipientCreditAmount:(int32_t)recipientCreditAmount redemptionEvent:(NSString *)redemptionEvent redemptionThresholdAmount:(int32_t)redemptionThresholdAmount senderCreditAmount:(int32_t)senderCreditAmount __attribute__((swift_name("init(enabled:recipientCreditAmount:redemptionEvent:redemptionThresholdAmount:senderCreditAmount:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplUserReferralConfigResponse *)doCopyEnabled:(BOOL)enabled recipientCreditAmount:(int32_t)recipientCreditAmount redemptionEvent:(NSString *)redemptionEvent redemptionThresholdAmount:(int32_t)redemptionThresholdAmount senderCreditAmount:(int32_t)senderCreditAmount __attribute__((swift_name("doCopy(enabled:recipientCreditAmount:redemptionEvent:redemptionThresholdAmount:senderCreditAmount:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplMetadataResponse.Companion")))
@interface AnsaSharedImplMetadataResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplMetadataResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplCustomerResponse.SquareCompanion")))
@interface AnsaSharedImplCustomerResponseSquareCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplCustomerResponseSquareCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPresetReloadAmountResponse_")))
@interface AnsaSharedImplPresetReloadAmountResponse_ : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplPresetReloadAmountResponse_Companion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t amount __attribute__((swift_name("amount")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) BOOL isMostPopular __attribute__((swift_name("isMostPopular")));
...
- (AnsaSharedImplPresetReloadAmountResponse_ *)doCopyId:(NSString *)id amount:(int32_t)amount isMostPopular:(BOOL)isMostPopular __attribute__((swift_name("doCopy(id:amount:isMostPopular:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAppReloadConfigurationResponse.Companion")))
@interface AnsaSharedImplAppReloadConfigurationResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplAppReloadConfigurationResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplAutoReloadConfigResponse.Companion")))
@interface AnsaSharedImplAutoReloadConfigResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplAutoReloadConfigResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplRewardTierResponse")))
@interface AnsaSharedImplRewardTierResponse : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedImplRewardTierResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t minTransactionRequirement __attribute__((swift_name("minTransactionRequirement")));
@property (readonly) int32_t promotionAmount __attribute__((swift_name("promotionAmount")));
- (instancetype)initWithMinTransactionRequirement:(int32_t)minTransactionRequirement promotionAmount:(int32_t)promotionAmount __attribute__((swift_name("init(minTransactionRequirement:promotionAmount:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedImplRewardTierResponse *)doCopyMinTransactionRequirement:(int32_t)minTransactionRequirement promotionAmount:(int32_t)promotionAmount __attribute__((swift_name("doCopy(minTransactionRequirement:promotionAmount:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPromotionsResponse.Companion")))
@interface AnsaSharedImplPromotionsResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplPromotionsResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplUserReferralConfigResponse.Companion")))
@interface AnsaSharedImplUserReferralConfigResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplUserReferralConfigResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplPresetReloadAmountResponse_.Companion")))
@interface AnsaSharedImplPresetReloadAmountResponse_Companion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplPresetReloadAmountResponse_Companion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImplRewardTierResponse.Companion")))
@interface AnsaSharedImplRewardTierResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedImplRewardTierResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
