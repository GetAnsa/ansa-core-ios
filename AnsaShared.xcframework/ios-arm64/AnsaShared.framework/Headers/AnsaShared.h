...
+ (void)Skie_Suspend__53__trySuspendFunDispatchReceiver:(AnsaSharedGreeting *)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__trySuspendFun(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__54__upgradeDispatchReceiver:(AnsaSharedKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<AnsaSharedKtor_ioByteReadChannel>)input output:(id<AnsaSharedKtor_ioByteWriteChannel>)output engineContext:(id<AnsaSharedKotlinCoroutineContext>)engineContext userContext:(id<AnsaSharedKotlinCoroutineContext>)userContext suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__55__awaitFreeSpaceDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__56__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKtor_ioChunkBuffer *)src suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__writeByteDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__61__writeDoubleDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__62__writeFloatDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__63__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver memory:(AnsaSharedKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__64__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKtor_ioBuffer *)src suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__writeFully(dispatchReceiver:src:suspendHandler:)")));
...
+ (void)Skie_Suspend__68__writeIntDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__69__writeLongDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__writeLong(dispatchReceiver:l:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__writePacketDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver packet:(AnsaSharedKtor_ioByteReadPacket *)packet suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__71__writeShortDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__72__writeSuspendSessionDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<AnsaSharedKotlinSuspendFunction1>)visitor suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__73__writeToDispatchReceiver:(AnsaSharedKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<AnsaSharedKtor_ioByteWriteChannel>)channel suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__writeTo(dispatchReceiver:channel:suspendHandler:)")));
