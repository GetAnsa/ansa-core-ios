...
- (instancetype)initWithId:(NSString *)id balance:(AnsaSharedBalance *)balance billingDetails:(AnsaSharedBillingDetails *)billingDetails email:(NSString * _Nullable)email merchantID:(NSString *)merchantID phone:(NSString * _Nullable)phone status:(NSString *)status referralCode:(NSString *)referralCode isTapToPayEnabled:(BOOL)isTapToPayEnabled autoReloadConfig:(AnsaSharedAutoReloadConfiguration * _Nullable)autoReloadConfig paymentMethods:(NSArray<AnsaSharedPaymentMethod *> *)paymentMethods __attribute__((swift_name("init(id:balance:billingDetails:email:merchantID:phone:status:referralCode:isTapToPayEnabled:autoReloadConfig:paymentMethods:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedCustomer *)doCopyId:(NSString *)id balance:(AnsaSharedBalance *)balance billingDetails:(AnsaSharedBillingDetails *)billingDetails email:(NSString * _Nullable)email merchantID:(NSString *)merchantID phone:(NSString * _Nullable)phone status:(NSString *)status referralCode:(NSString *)referralCode isTapToPayEnabled:(BOOL)isTapToPayEnabled autoReloadConfig:(AnsaSharedAutoReloadConfiguration * _Nullable)autoReloadConfig paymentMethods:(NSArray<AnsaSharedPaymentMethod *> *)paymentMethods __attribute__((swift_name("doCopy(id:balance:billingDetails:email:merchantID:phone:status:referralCode:isTapToPayEnabled:autoReloadConfig:paymentMethods:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) BOOL isTapToPayEnabled __attribute__((swift_name("isTapToPayEnabled")));
@property (readonly) NSString *referralCode __attribute__((swift_name("referralCode")));
- (instancetype)initWithReferralCode:(NSString *)referralCode isTapToPayEnabled:(BOOL)isTapToPayEnabled __attribute__((swift_name("init(referralCode:isTapToPayEnabled:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedCustomer_implCustomerResponseAnsaMetadata *)doCopyReferralCode:(NSString *)referralCode isTapToPayEnabled:(BOOL)isTapToPayEnabled __attribute__((swift_name("doCopy(referralCode:isTapToPayEnabled:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
