...
@property (class, readonly, getter=companion) AnsaSharedBalanceUpdateCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BalanceUpdate.Companion")))
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApplePaymentContact")))
@interface AnsaSharedApplePaymentContact : AnsaSharedBase
@property (readonly) NSString * _Nullable addressLines __attribute__((swift_name("addressLines")));
...
- (instancetype)initWithAddressLines:(NSString * _Nullable)addressLines country:(NSString * _Nullable)country countryCode:(NSString * _Nullable)countryCode familyName:(NSString * _Nullable)familyName givenName:(NSString * _Nullable)givenName postalCode:(NSString * _Nullable)postalCode __attribute__((swift_name("init(addressLines:country:countryCode:familyName:givenName:postalCode:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedApplePaymentContact *)doCopyAddressLines:(NSString * _Nullable)addressLines country:(NSString * _Nullable)country countryCode:(NSString * _Nullable)countryCode familyName:(NSString * _Nullable)familyName givenName:(NSString * _Nullable)givenName postalCode:(NSString * _Nullable)postalCode __attribute__((swift_name("doCopy(addressLines:country:countryCode:familyName:givenName:postalCode:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) AnsaSharedApplePaymentContact *billingContact __attribute__((swift_name("billingContact")));
...
@property (readonly) AnsaSharedApplePaymentContact *shippingContact __attribute__((swift_name("shippingContact")));
@property (readonly) NSString *transactionIdentifier __attribute__((swift_name("transactionIdentifier")));
- (instancetype)initWithPaymentMethod:(AnsaSharedApplePaymentMethod *)paymentMethod paymentInfo:(AnsaSharedApplePaymentInformation *)paymentInfo transactionIdentifier:(NSString *)transactionIdentifier billingContact:(AnsaSharedApplePaymentContact *)billingContact shippingContact:(AnsaSharedApplePaymentContact *)shippingContact __attribute__((swift_name("init(paymentMethod:paymentInfo:transactionIdentifier:billingContact:shippingContact:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedPaymentDataInterfaceApplePaymentData *)doCopyPaymentMethod:(AnsaSharedApplePaymentMethod *)paymentMethod paymentInfo:(AnsaSharedApplePaymentInformation *)paymentInfo transactionIdentifier:(NSString *)transactionIdentifier billingContact:(AnsaSharedApplePaymentContact *)billingContact shippingContact:(AnsaSharedApplePaymentContact *)shippingContact __attribute__((swift_name("doCopy(paymentMethod:paymentInfo:transactionIdentifier:billingContact:shippingContact:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
+ (void)Skie_Suspend__20__getResultDispatchReceiver:(AnsaSharedKtorWrapper *)dispatchReceiver resource:(id)resource authType:(id<AnsaSharedAuthType>)authType builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__20__getResult(dispatchReceiver:resource:authType:builder:suspendHandler:)")));
+ (void)Skie_Suspend__21__postResultDispatchReceiver:(AnsaSharedKtorWrapper *)dispatchReceiver resource:(id)resource body:(id _Nullable)body authType:(id<AnsaSharedAuthType>)authType idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__21__postResult(dispatchReceiver:resource:body:authType:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__22__postResultDispatchReceiver:(AnsaSharedKtorWrapper *)dispatchReceiver resource:(id)resource authType:(id<AnsaSharedAuthType>)authType idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__22__postResult(dispatchReceiver:resource:authType:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__23__postResultDispatchReceiver:(AnsaSharedKtorWrapper *)dispatchReceiver url:(NSString *)url body:(id _Nullable)body authType:(id<AnsaSharedAuthType>)authType idempotencyKey:(NSString * _Nullable)idempotencyKey suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__23__postResult(dispatchReceiver:url:body:authType:idempotencyKey:suspendHandler:)")));
+ (void)Skie_Suspend__24__handleAuthDispatchReceiver:(AnsaSharedKtorWrapper *)dispatchReceiver extensionReceiver:(AnsaSharedKtor_client_coreHttpRequestBuilder *)extensionReceiver authType:(id<AnsaSharedAuthType>)authType suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__24__handleAuth(dispatchReceiver:extensionReceiver:authType:suspendHandler:)")));
+ (void)Skie_Suspend__25__joinDispatchReceiver:(id<AnsaSharedKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__25__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__26__executeDispatchReceiver:(AnsaSharedKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__26__execute(dispatchReceiver:context:subject:suspendHandler:)")));
+ (void)Skie_Suspend__27__invokeDispatchReceiver:(id<AnsaSharedKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__27__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__28__bodyDispatchReceiver:(AnsaSharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(AnsaSharedKtor_utilsTypeInfo *)info suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__28__body(dispatchReceiver:info:suspendHandler:)")));
+ (void)Skie_Suspend__29__bodyNullableDispatchReceiver:(AnsaSharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(AnsaSharedKtor_utilsTypeInfo *)info suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__29__bodyNullable(dispatchReceiver:info:suspendHandler:)")));
...
*/
+ (void)Skie_Suspend__30__getResponseContentDispatchReceiver:(AnsaSharedKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__30__getResponseContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__31__awaitContentDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__31__awaitContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__32__discardDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver max:(int64_t)max suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__32__discard(dispatchReceiver:max:suspendHandler:)")));
+ (void)Skie_Suspend__33__peekToDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver destination:(AnsaSharedKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__33__peekTo(dispatchReceiver:destination:destinationOffset:offset:min:max:suspendHandler:)")));
+ (void)Skie_Suspend__34__readAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver dst:(AnsaSharedKtor_ioChunkBuffer *)dst suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__34__readAvailable(dispatchReceiver:dst:suspendHandler:)")));
+ (void)Skie_Suspend__35__readAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver dst:(AnsaSharedKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__35__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
...
+ (void)Skie_Suspend__38__readBooleanDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__38__readBoolean(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__39__readByteDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__39__readByte(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__40__readDoubleDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__40__readDouble(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__41__readFloatDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__41__readFloat(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__42__readFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver dst:(AnsaSharedKtor_ioChunkBuffer *)dst n:(int32_t)n suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__readFully(dispatchReceiver:dst:n:suspendHandler:)")));
+ (void)Skie_Suspend__43__readFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver dst:(AnsaSharedKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
...
+ (void)Skie_Suspend__46__readIntDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__readInt(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__47__readLongDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__readLong(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__48__readPacketDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver size:(int32_t)size suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__readPacket(dispatchReceiver:size:suspendHandler:)")));
+ (void)Skie_Suspend__49__readRemainingDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver limit:(int64_t)limit suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__readRemaining(dispatchReceiver:limit:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__readShortDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__readShort(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__51__readSuspendableSessionDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver consumer:(id<AnsaSharedKotlinSuspendFunction1>)consumer suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__readSuspendableSession(dispatchReceiver:consumer:suspendHandler:)")));
+ (void)Skie_Suspend__52__readUTF8LineDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver limit:(int32_t)limit suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__readUTF8Line(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__53__readUTF8LineToDispatchReceiver:(id<AnsaSharedKtor_ioByteReadChannel>)dispatchReceiver out:(id<AnsaSharedKotlinAppendable>)out limit:(int32_t)limit suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__readUTF8LineTo(dispatchReceiver:out:limit:suspendHandler:)")));
+ (void)Skie_Suspend__54__invokeDispatchReceiver:(id<AnsaSharedKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__55__executeDispatchReceiver:(id<AnsaSharedKtor_client_coreHttpClientEngine>)dispatchReceiver data:(AnsaSharedKtor_client_coreHttpRequestData *)data suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__56__getValidSessionOrNullDispatchReceiver:(id<AnsaSharedAuthSessionManager>)dispatchReceiver ansaCustomerId:(NSString *)ansaCustomerId suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__getValidSessionOrNull(dispatchReceiver:ansaCustomerId:suspendHandler:)")));
+ (void)Skie_Suspend__57__refreshSessionDispatchReceiver:(id<AnsaSharedAuthSessionManager>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__refreshSession(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__58__hasNextDispatchReceiver:(AnsaSharedSkieColdFlowIterator<id> *)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__hasNext(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__59__upgradeDispatchReceiver:(AnsaSharedKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<AnsaSharedKtor_ioByteReadChannel>)input output:(id<AnsaSharedKtor_ioByteWriteChannel>)output engineContext:(id<AnsaSharedKotlinCoroutineContext>)engineContext userContext:(id<AnsaSharedKotlinCoroutineContext>)userContext suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__awaitFreeSpaceDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__61__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKtor_ioChunkBuffer *)src suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__62__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__63__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__64__writeAvailableDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__65__writeByteDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__66__writeDoubleDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__67__writeFloatDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__68__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver memory:(AnsaSharedKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__69__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKtor_ioBuffer *)src suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__writeFully(dispatchReceiver:src:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(AnsaSharedKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__71__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__72__writeFullyDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__73__writeIntDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__74__writeLongDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__75__writePacketDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver packet:(AnsaSharedKtor_ioByteReadPacket *)packet suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__76__writeShortDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__77__writeSuspendSessionDispatchReceiver:(id<AnsaSharedKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<AnsaSharedKotlinSuspendFunction1>)visitor suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__78__writeToDispatchReceiver:(AnsaSharedKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<AnsaSharedKtor_ioByteWriteChannel>)channel suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__79__deleteResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__79__deleteResult(extensionReceiver:resource:builder:suspendHandler:)")));
...
+ (void)Skie_Suspend__80__getResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__80__getResult(extensionReceiver:resource:builder:suspendHandler:)")));
+ (void)Skie_Suspend__81__postResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource body:(id _Nullable)body builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__81__postResult(extensionReceiver:resource:body:builder:suspendHandler:)")));
+ (void)Skie_Suspend__82__postResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver resource:(id)resource builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__82__postResult(extensionReceiver:resource:builder:suspendHandler:)")));
+ (void)Skie_Suspend__83__postResultExtensionReceiver:(AnsaSharedKtor_client_coreHttpClient *)extensionReceiver url:(NSString *)url body:(id _Nullable)body builder:(void (^)(AnsaSharedKtor_client_coreHttpRequestBuilder *))builder suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__83__postResult(extensionReceiver:url:body:builder:suspendHandler:)")));
+ (void)Skie_Suspend__84__safeBodyExtensionReceiver:(AnsaSharedKtor_client_coreHttpResponse *)extensionReceiver suspendHandler:(AnsaSharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__84__safeBody(extensionReceiver:suspendHandler:)")));
