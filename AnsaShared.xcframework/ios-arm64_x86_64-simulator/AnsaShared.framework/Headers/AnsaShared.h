 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)provisionVirtualCardRequest:(AnsaSharedProvisioningRequest *)request idempotencyKey:(NSString * _Nullable)idempotencyKey completionHandler:(void (^)(AnsaSharedApiResult<AnsaSharedProvisioning *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("provisionVirtualCard(request:idempotencyKey:completionHandler:)")));
...
@interface AnsaSharedProvisioning : AnsaSharedBase
@property (class, readonly, getter=companion) AnsaSharedProvisioningCompanion *companion __attribute__((swift_name("companion")));
...
- (AnsaSharedProvisioning *)doCopyProvisioningPayload:(NSString *)provisioningPayload ephemeralPublicKey:(NSString *)ephemeralPublicKey encryptedData:(NSString *)encryptedData __attribute__((swift_name("doCopy(provisioningPayload:ephemeralPublicKey:encryptedData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Provisioning.Companion")))
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Customer_implProvisioningMapper")))
@interface AnsaSharedCustomer_implProvisioningMapper : AnsaSharedBase <AnsaSharedCore_implMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AnsaSharedProvisioning *)mapFrom:(AnsaSharedCustomer_implProvisioningResponse *)from __attribute__((swift_name("map(from:)")));
@end
...
@property (class, readonly, getter=companion) AnsaSharedCustomer_implProvisioningResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *encryptedData __attribute__((swift_name("encryptedData")));
@property (readonly) NSString *ephemeralPublicKey __attribute__((swift_name("ephemeralPublicKey")));
@property (readonly) NSString *provisioningPayload __attribute__((swift_name("provisioningPayload")));
- (instancetype)initWithProvisioningPayload:(NSString *)provisioningPayload ephemeralPublicKey:(NSString *)ephemeralPublicKey encryptedData:(NSString *)encryptedData __attribute__((swift_name("init(provisioningPayload:ephemeralPublicKey:encryptedData:)"))) __attribute__((objc_designated_initializer));
- (AnsaSharedCustomer_implProvisioningResponse *)doCopyProvisioningPayload:(NSString *)provisioningPayload ephemeralPublicKey:(NSString *)ephemeralPublicKey encryptedData:(NSString *)encryptedData __attribute__((swift_name("doCopy(provisioningPayload:ephemeralPublicKey:encryptedData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Customer_implProvisioningResponse.Companion")))
@interface AnsaSharedCustomer_implProvisioningResponseCompanion : AnsaSharedBase
@property (class, readonly, getter=shared) AnsaSharedCustomer_implProvisioningResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AnsaSharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
